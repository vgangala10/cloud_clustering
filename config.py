...
embedding = {
    'embedding_size': 100,
    'number_of_files': 5,
    'path': '/storage/climate-memmap/models/ResNet34/embedding_75_transform_files_60',
    'model_directory': '/storage/climate-memmap/models/ResNet34/embedding_75_transform_files_60/best_model-epoch=46-val_loss=0.00.ckpt',
    ...
    'embeddings_memmap_path': '/storage/climate-memmap/models/ResNet34/embedding_75_transform_files_60/test_embeddings_75_coords.memmap'
}
